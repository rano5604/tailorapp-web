...
export default async function Page({
    ...
    const url = `${API_BASE}/api/dashboard/orders/tomorrow?shopId=${shopId}&page=${page}&limit=${limit}`
    ...
    return (
        <main className={styles.page}>
            ...
            <section className={styles.titleSection}><h2 className={styles.pageTitle}>Delivery Tomorrow</h2></section>
